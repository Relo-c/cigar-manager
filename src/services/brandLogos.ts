const logoFiles: Record<string, string> = {
  ...
  '圣克里斯托': 'san-cristobal-de-la-habana.jpg',
...
export const habanosBrands: HabanosBrand[] = [
  ...
  { name: '圣克里斯托瓦尔', english: 'San Cristóbal de La Habana', aliases: ['圣克里斯托', '圣克里斯托瓦尔哈瓦那'], file: 'san-cristobal-de-la-habana.jpg' },
  ...
  { name: '奥赛码头', english: "Quai d'Orsay", aliases: ['多尔塞码头'], file: 'quai-d-orsay.jpg' },
