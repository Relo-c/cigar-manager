...
<template><section><header class="page-header"><p class="eyebrow">原盒养护</p><h1>{{ inventory.boxCount }} 盒库存</h1></header><van-search v-model="query" placeholder="搜索品牌、型号、年份或柜号" shape="round" />
  ...
  <van-floating-bubble icon="plus" axis="xy" magnetic="x" @click="open()" />
